...
/** Ordered sections — each maps to `privacy.sections.<id>` with `title` + `body[]`. */
const SECTION_IDS = [
  'controller',
  'dataCollected',
  'purposes',
...
function PrivacySection({ number, id, title, body, index }) {
  return (
    <motion.section
      id={sectionAnchor(id)}
    ...
    <section className="relative -mt-16 overflow-hidden bg-[#f3eee6] pb-20 pt-24 md:pb-28 md:pt-32">
      <div className="relative mx-auto max-w-[1120px] px-6 md:px-8">
        ...
        >
          ...
          <span className="text-[#171412]">{t('privacy.breadcrumb')}</span>
        </motion.nav>
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <p className="mt-6 font-sans text-[11px] font-medium uppercase tracking-[0.18em] text-[#9a948e]">
                {tf('privacy.footnote', { hotel: CONTACT.hotelName })}
              </p>
            </motion.div>
          </div>
        </div>
