 ...
 *
 * Locale-independent fields (`schemaType`, `capacity`, `areaM2`, `quantity`,
 * `view`, `beds`, `amenities`) feed schema.org structured data and are kept in
 * English so crawlers read stable feature names regardless of the visible locale.
 */
export const ROOM_SEO_META = {
  presidential: {
    ...
    amenities: [
      'Private terrace with hydromassage tub',
      'Mediterranean sea view',
      'Freestanding bathtub',
      'Walk-in rain shower',
      'Lalique bath amenities',
  ...
  junior: {
    ...
    beds: [
      { type: 'Double bed', count: 1 },
      { type: 'Convertible armchair bed', count: 1 },
    ],
    amenities: [
  ...
  'standard-view-double': {
    ...
    quantity: 31,
    view: 'Sea view',
    beds: [{ type: 'Double bed or twin beds on request', count: 1 }],
    amenities: [
      'Private balcony with sea views',
      'Double bed or twin beds on request',
      'Spacious bathroom with shower',
      'Lalique bath amenities',
      'Bathrobes and slippers',
      'Minibar',
  ...
  'standard-partial-double': {
    ...
    beds: [{ type: 'Double bed or twin beds on request', count: 1 }],
    amenities: [
      'Private balcony with partial sea views',
      'Double bed or twin beds on request',
      'Spacious bathroom with shower',
      'Lalique bath amenities',
      'Bathrobes and slippers',
...
/** Stable, crawler-friendly OG/social image for the suites listing (public path). */
export const SUITES_OG_IMAGE_PATH = '/og/suites-rooms.jpg'

/** Stable per-room OG/social image (public path). Generated by `scripts/generate-og-images.mjs`. */
export function roomOgImagePath(slug) {
  return `/og/rooms/${slug}.jpg`
}
