...
export const roomsEs = {
  ...
  junior: {
    title: 'Junior Suite',
    images: [
      { alt: 'Dormitorio de la Junior Suite visto desde el pasillo de entrada, con balcón y luz natural' },
      { alt: 'Dormitorio de la Junior Suite con cabecero terracota, acentos verdes y lámparas de rattan' },
      { alt: 'Puertas del balcón de la Junior Suite abiertas hacia una terraza con vistas parciales al mar' },
      { alt: 'Balcón privado de la Junior Suite con sillas de fibras, mesa y vista parcial al Mediterráneo' },
      { alt: 'Junior Suite con armario de lamas y balcón con vistas al mar' },
      { alt: 'Vista completa del dormitorio de la Junior Suite con ropa de cama Guardamar y decoración costera' },
      { alt: 'Cama doble de la Junior Suite con cabecero tapizado naranja y cuadros de conchas marinas' },
      { alt: 'Cama de la Junior Suite con cojines de terciopelo verde y cuadros de conchas sobre el cabecero' },
      { alt: 'Primer plano de la cama de la Junior Suite con cojines verdes bordados con el logo Guardamar' },
      { alt: 'Detalle de la ropa de cama de la Junior Suite con colcha verde y cojines de terciopelo de la casa' },
      { alt: 'Zona de noche de la Junior Suite con lámpara de rattan y mesita de noche con frente de caña' },
      { alt: 'Mesita de noche de la Junior Suite con copas de vino bajo una lámpara de rattan con flecos' },
      { alt: 'Televisor de pantalla plana en la pared de la Junior Suite sobre la cama con colcha verde' },
      { alt: 'Armario y puerta del balcón de la Junior Suite con vistas luminosas al mar' },
      { alt: 'Pasillo de entrada privado de la Junior Suite con paredes texturizadas y suelo de madera' },
    ],
    features: [
      { label: '4 unidades', icon: 'units' },
